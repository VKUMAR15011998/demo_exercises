        ...
        return Controller.extend("projectlnc.controller.View1", {
            ...
            _onObjectMatched: function (oEvent) {
                ...
                if (oEvent.getParameter("arguments").lrftype === "None" && oEvent.getParameter("arguments").refno !== "None") {
                    ...
                    oModel.read('/Get_Adani_Logistics_LRF_Master', {
                        filters: afilters,
                        urlParameters: {
            ...
            go2: function () {
                ...
                if (res) {
                    ...
                    console.log(data1)
                    if (data['Lrf_No'] == "") {
                        oModel.create('/Get_Adani_Logistics_LRF_Master', data1, {
                        ...
                        var sEntitySet = "/Get_Adani_Logistics_LRF_Master";
            ...
            go3: function () {
                ...
                if (res) {
                    ...
                    var data1 = {
                        ...
                        "PO_Inco_Terms": data['inco_terms'],
                        "Act_Incoterms": data['delivery_terms'],
                    ...
                    if (data['contact'] === 'Yes') {
                        ...
                        data1["Ship_Country_code"] = data['c_country_code'];
